...
function logRequestError(gutil, action, err) {
    ...
    if (err.message.toLowerCase().indexOf("ssl")) {
        ...
        logError(gutil, 'Check to make sure your stage community is up, and that you have the correct serverUrl and pluginUploadProtocol' +
        ' properties set in server.conf.json and that SSL support has been configured correctly on your stage community.');
    }
