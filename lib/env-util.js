      ...
      moduleDependencies: getSourcePaths(
        (function () {
          ...
          Object.keys(sdkConf.ng.moduleDependencies || {}).forEach(function (key) {
            ...
            if (Array.isArray(sdkConf.ng.moduleDependencies[key])) {
              deps = deps.concat(sdkConf.ng.moduleDependencies[key]);
            }
            if ('dev' in sdkConf.ng.moduleDependencies[key] && Array.isArray(sdkConf.ng.moduleDependencies[key].dev)) {
              deps = deps.concat(sdkConf.ng.moduleDependencies[key].dev);
            }
            if ('min' in sdkConf.ng.moduleDependencies[key] && Array.isArray(sdkConf.ng.moduleDependencies[key].min)) {
              deps = deps.concat(sdkConf.ng.moduleDependencies[key].min);
            }
