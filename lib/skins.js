...
module.exports = function (gulp, gutil) {
  ...
  function withOptions(cb) {
    ...
    if (server.useResponsiveConfigsFromServer()) {
      ...
      return respOptions.getOptions(opts, function (config) {
  ...
  return {
    ...
    compile: function (lr) {
      ...
      if (server.useResponsiveConfigsFromServer()) {
        var getCorePluginFiles = function() {
          return getResponsiveOptions().getOptions(opts, function (config) {
        ...
        return streamSync([getCorePluginFiles, runCompile]);
      } else {
        return doCompile(opts);
      }
    },
