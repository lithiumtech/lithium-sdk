...
module.exports = function (gulp, gutil) {
  ...
  function doCompile(opts) {
    var skinPath = opts.includePathsPrefix + 'res/feature/' + opts.feature +
  ...
  function options() {
    ...
    if (server.useResponsiveConfigsFromServer()) {
      return new Promise(function (resolve) {
        responsiveOptions.getOptions(server, opts, function (err) {
          if (err) {
            throw err;
          }
        ...
        return setOptionsFromConfig(config, opts);
      });
    } else {
    ...
    return options().then(function (opts) {
      ...
      if (server.useResponsiveConfigsFromServer()) {
        ...
        if (!coreOutputDirExists) {
          return new Promise(function (resolve) {
            pluginExport.exportCorePlugin(server, opts, undefined, function () {}).on('end', function () {
