...
module.exports = function (gulp, gutil) {
  ...
  var baseFeaturePath = gutil.env.newStructure ? 'dist/plugin/res/feature/responsivebase/' : 'res/feature/responsivebase/';
  var peakFeaturePath = gutil.env.newStructure ? 'dist/plugin/res/feature/responsivepeak/' : 'res/feature/responsivepeak/';
  var skinsBaseDir = gutil.env.newStructure ? 'dist/plugin/res/skins' : 'res/skins';
