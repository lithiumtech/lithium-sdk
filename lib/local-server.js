...
module.exports = function (gulp, gutil) {
  ...
  function startLocalServer() {
    ...
    skins.options().then(function (opts) {
      var pluginResPath = gutil.env.newStructure ? 'dist/plugin/res' : 'plugin/res';
      var pluginWebPath = gutil.env.newStructure ? 'dist/plugin/web' : 'plugin/web';
      var webSrcPath = gutil.env.newStructure ? 'plugin/web' : 'web';
      var angularLiSrcPath = gutil.env.newStructure ? 'angular-li/src' : 'src';
      function runServer() {
        connect().server({
          root: [
            webSrcPath,
