...
var JS_DEMO_PATTERN = 'src/!(activecast)/**/*.demo.js';
var JS_MOCK_PATTERN = 'src/!(activecast)/**/*.mock.js';
var JS_SPEC_PATTERN = 'src/!(activecast)/**/*.spec.js';
var TPL_PATTERN = 'src/!(activecast)/**/!(*.demo).tpl.html';
