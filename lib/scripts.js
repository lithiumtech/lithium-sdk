...
const REACT_LI_COMPONENT_PATH = 'react-li/components/';
const COMPONENT_DEPS_SRC_PATH = 'react-li/src/components';
const COMPONENT_DEPS_DEST_PATH = 'plugin/res/feature/component-dependencies.json';
