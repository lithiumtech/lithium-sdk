...
var JS_MAIN_PATTERN = 'src/!(activecast|react-li)/**/!(*.demo|*.spec|*.mock).js';
var JS_DEMO_PATTERN = 'src/!(activecast|react-li)/**/*.demo.js';
var JS_MOCK_PATTERN = 'src/!(activecast|react-li)/**/*.mock.js';
var JS_SPEC_PATTERN = 'src/!(activecast|react-li)/**/*.spec.js';
var TPL_PATTERN = 'src/!(activecast|react-li)/**/!(*.demo).tpl.html';
