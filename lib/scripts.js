...
var JS_MAIN_PATTERN = 'src/!(activecast|limuirs)/**/!(*.demo|*.spec|*.mock).js';
var JS_DEMO_PATTERN = 'src/!(activecast|limuirs)/**/*.demo.js';
var JS_MOCK_PATTERN = 'src/!(activecast|limuirs)/**/*.mock.js';
var JS_SPEC_PATTERN = 'src/!(activecast|limuirs)/**/*.spec.js';
var TPL_PATTERN = 'src/!(activecast|limuirs)/**/!(*.demo).tpl.html';
...
const COMPONENT_DEPS_SRC_PATH = 'src/limuirs/src/components';
