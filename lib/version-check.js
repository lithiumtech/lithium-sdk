...
module.exports = function (gulp, gutil) {
    ...
    function parseResponse(cb, body) {
        ...
        var badResponseErrMessage = 'Invalid response from server. Check your server url and plugin token.';
        if ( !body ) {
        ...
        try {
            ...
            pluginUtils.logError(gutil, badResponseErrMessage+" : "+error.message);
            return;
        }
