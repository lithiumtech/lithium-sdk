                ...
                if (res.statusCode > 201) {
                    ...
                    zipEntries.forEach(function (zipEntry) {
                        if (zipEntry.name !== 'Manifest.MF') {
                            if (useVerboseMode) {
                                putils.logInfo(gutil, 'downloading ' + zipEntry.entryName);
                            }
                            ...
                            var outputTo = outputToBase + "/" + entryPath;
                            zip.extractEntryTo(zipEntry.entryName, path.normalize(outputTo), false, true);
                        }
                    });
