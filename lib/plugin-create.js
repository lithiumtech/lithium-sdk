  ...
  var RULES = [
    // expected files
    {
      ...
      expectations: [
        ...
        'res/lang/text.{ar,bg,ca,cs,da,de,el,es,es-mx,fi,fr,he,hr,hu,id,in,it,iw,ja,kk,ko,lv,ms,nb,nl,no,' +
          'pl,pt,pt-br,pt-pt,ro,ru,sk,sq,sv,th,tr,uk,vi,zh-cn,zh-tw}.(UTF-8).properties',
        'res/lang/text.{en,en-gb}/*.text',
        'res/lang/text.{ar,bg,ca,cs,da,de,el,es,es-mx,fi,fr,he,hr,hu,id,in,it,iw,ja,kk,ko,lv,ms,nb,nl,no,' +
          'pl,pt,pt-br,pt-pt,ro,ru,sk,sq,sv,th,tr,uk,vi,zh-cn,zh-tw}.(UTF-8)/*.text',
        ...
        'res/feature/*/*/res/lang/text.{ar,bg,ca,cs,da,de,el,es,es-mx,fi,fr,he,hr,hu,id,in,it,iw,ja,kk,ko,lv,ms,nb,nl,no,' +
          'pl,pt,pt-br,pt-pt,ro,ru,sk,sq,sv,th,tr,uk,vi,zh-cn,zh-tw}.(UTF-8).properties',
        ...
        'res/feature/*/*/res/skins/**/sass/**/*.scss.var',
    ...
    // expected directories
    {
      ...
      expectations: allDirTreePaths([
        ...
        'res/lang/text.{ar,bg,ca,cs,da,de,el,es,es-mx,fi,fr,hr,hu,in,it,iw,ja,kk,ko,lv,ms,nl,no,pl,pt,pt-br,ro,ru,sk,sq,' +
        ...
        'res/feature/*/*/res/lang/text.{ar,bg,ca,cs,da,de,el,es,es-mx,fi,fr,hr,hu,in,it,iw,ja,kk,ko,lv,ms,nl,no,pl,pt,pt-br,ro,ru,sk,sq,' +
          'sv,th,tr,uk,vi,zh-cn,zh-tw}.(UTF-8)',
      ...
      return streamSync(
        ...
        RULES.map(function (rule) {
          return function () {
            ...
            return gulp.src(rule.pattern, { cwd: 'plugin', read: false })
