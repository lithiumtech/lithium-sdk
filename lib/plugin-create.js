  ...
  var RULES = [
    // expected files
    {
      ...
      expectations: [
        ...
        'res/lang/text.{ar,bg,ca,cs,da,de,el,es,es-mx,fi,fr,he,hr,hu,id,in,it,iw,ja,kk,ko,ms,nb,nl,no,' + 
        ...
        'res/feature/*/*/res/lang/text.{ar,bg,ca,cs,da,de,el,es,es-mx,fi,fr,he,hr,hu,id,in,it,iw,ja,kk,ko,ms,nb,nl,no,' + 
          'pl,pt,pt-br,pt-pt,ro,ru,sk,sq,sv,th,tr,uk,vi,zh-cn,zh-tw}.(UTF-8).properties',
