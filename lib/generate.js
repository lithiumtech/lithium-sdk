...
module.exports = function (gulp, gutil) {
  ...
  function fixSkinProperties(opts) {
    ...
    try {
      ...
      var idx;
      var line;
      for (idx = 0; idx < spropsLines.length; idx++) {
        line = spropsLines[idx];
  ...
  function fixSkinScss(opts) {
    ...
    try {
      ...
      var idx;
      var line;
      for (idx = 0; idx < skinScssLines.length; idx++) {
        line = skinScssLines[idx];
        // don't keep parent line
  ...
  return {
    ...
    clone: function (cb) {
      ...
      var fileBase = gutil.env.newStructure ? 'angular-li/bower_components/angular-li/src/' : 'bower_components/angular-li/src/';
