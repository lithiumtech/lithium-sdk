...
module.exports = function (gulp, gutil) {
  ...
  function mergeBaseAndPeak(cb) {
    ...
    var baseVendorPath = getSkinPath(opts.baseFeature, 'common', opts.baseSkin);
    var destVendorPath = getSkinPath(opts.destFeature, 'common', opts.destSkin);
